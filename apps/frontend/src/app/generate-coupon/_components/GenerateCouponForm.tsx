...
export default function GenerateCouponForm() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(fetchInvoiceDetails, 500);
  ...
  const requestOtpMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      otpIntervalRef.current = setInterval(() => {
        timer -= 1;
        setOtpTimer(timer);
        if (timer <= 0 && otpIntervalRef.current) {
          clearInterval(otpIntervalRef.current);
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={requestOtpMutation.isPending || isLoadingInvoice}
              className="w-full"
            >
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <Button
                ...
                disabled={resendOtpMutation.isPending || otpTimer > 240}
              >
